...
void VulkanRenderer::createGraphicsPipeline()
{
	...
	vertexInputCreateInfo.pVertexBindingDescriptions = nullptr; // List of Binding Descriptions (data spacing/ stride info)
	vertexInputCreateInfo.vertexAttributeDescriptionCount = 0;
	vertexInputCreateInfo.pVertexAttributeDescriptions = nullptr; // List of vertex attriobute descrptions (data format and where to get it)
...
void VulkanRenderer::recordCommands()
{
	...
	bufferBeginInfo.flags = VK_COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE_BIT; // Buffer can be resubmitted when it has been already submitter and waiting execution
