...
void VulkanRenderer::createRenderPass()
{
	...
	swapchainColorAttachment.loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR; // Describe what to do with attachment before rendering
...
void VulkanRenderer::createGraphicsPipeline()
{
	...
	// Create seonc pass pipeline
	// Second pass shaders
	auto secondVertexShaderCode = readFile("src/shaders/second_vert.spv");
	auto secondFragmentShaderCode = readFile("src/shaders/second_frag.spv");
